...
namespace TangoBot.Core.Domain.DTOs
{
    public class AccountStatusDto
    {
        ...
        public string FuturesMarginRateMultiplierRaw { get; set; }

        [JsonIgnore]
        public decimal FuturesMarginRateMultiplier => decimal.TryParse(FuturesMarginRateMultiplierRaw, out var result) ? result : 0;
        ...
        public string SmallNotionalFuturesMarginRateMultiplierRaw { get; set; }

        [JsonIgnore]
        public decimal SmallNotionalFuturesMarginRateMultiplier => decimal.TryParse(SmallNotionalFuturesMarginRateMultiplierRaw, out var result) ? result : 0;
